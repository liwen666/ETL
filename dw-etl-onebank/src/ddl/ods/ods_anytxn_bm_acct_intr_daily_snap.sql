DROP TABLE IF EXISTS "ods_anytxn_bm_acct_intr_daily_snap";
CREATE TABLE "ods_anytxn_bm_acct_intr_daily_snap" (
  ...
  "etl_date" int4,
  CONSTRAINT "ods_anytxn_bm_acct_intr_daily_snap_pkey" PRIMARY KEY ("biz_date","txa_number")
);