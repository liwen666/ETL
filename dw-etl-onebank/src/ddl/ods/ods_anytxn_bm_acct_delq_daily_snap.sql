DROP TABLE IF EXISTS ods_anytxn_bm_acct_delq_daily_snap;

create table ods_anytxn_bm_acct_delq_daily_snap
(
	...
	real_channel varchar(23) not null,
	 CONSTRAINT ods_anytxn_bm_acct_delq_daily_snap_pkey PRIMARY KEY (biz_date,txa_number)
);
