...
DROP TABLE IF EXISTS "ods_anytxn_bm_acct_loan_detl_daily_snap";
create table public.ods_anytxn_bm_acct_loan_detl_daily_snap
(
	...
	real_channel varchar(23) not null,
	 CONSTRAINT ods_anytxn_bm_acct_loan_detl_daily_snap_pkey PRIMARY KEY (biz_date,txa_number)
